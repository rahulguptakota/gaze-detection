...
shell1 = pygame.Surface((50, 50))
shell2 = pygame.Surface((50, 50))
shell3 = pygame.Surface((50, 50))
shell4 = pygame.Surface((50, 50))
#pygame.draw.circle(Surface, color,, pos, radius, width=0)
# draw blue filled circle on ball surface
pygame.draw.circle(ballsurface, (255, 255, 255), (25, 25), 20)
pygame.draw.circle(shell1, (255, 255, 255), (25, 25), 20, 2)
pygame.draw.circle(shell2, (255, 255, 255), (25, 25), 20, 2)
pygame.draw.circle(shell3, (255, 255, 255), (25, 25), 20, 2)
pygame.draw.circle(shell4, (255, 255, 255), (25, 25), 20, 2)
...
# using a trained Linear SVM on previously obtained data
...
while(time.time()-start<100):
	...
	eye = np.hstack((eyel, eyer))
	# eye = equalize_hist(eye) #histogram equilisation
	lbpTime = time.time()
	...
	# print "Webcam Time: ", webEndTime-webTime, " Face Detection Time: ", faceEndTime-faceTime, "Face Landmark Det time: ", landEndTime-landTime, "LBP Time: ", lbpEndTime-lbpTime, "SVM Prediction time: ", svmEndTime - svmTime
	# pred_i = (pred_i+1)%5
	# a=maxkey
	if(a==4):
		ballx = 0.95*screen_x
